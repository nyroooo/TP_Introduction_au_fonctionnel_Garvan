...
function executerP5() {
    ...
    console.log("Au moins un mineur :", utilisateurs.some(u => u.age < 18));
    console.log("Tous ont plus de 10 ans :", utilisateurs.every(u => u.age > 10));
    ...
    const tousLesHobbies = utilisateursAvecHobbies.flatMap(u => u.hobbies);
    console.log("Tous les hobbies :", tousLesHobbies);
    const triesParAge = [...utilisateurs].sort((a, b) => a.age - b.age);
